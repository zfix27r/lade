...
@Composable
private fun SourceChip(source: CalendarBusySource) {
...
@Composable
private fun sourceVisual(source: CalendarBusySource): Pair<Int, ImageVector> = when (source) {
	CalendarBusySource.MANUAL -> R.string.calendar_source_manual to Icons.Default.EditCalendar
	CalendarBusySource.SCHEDULE -> R.string.calendar_source_schedule to Icons.Default.Schedule
